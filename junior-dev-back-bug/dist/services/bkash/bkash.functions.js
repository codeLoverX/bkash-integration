...
class BaseClass {
  ...
  async grantToken() {
    try {
      ...
      if ((res === null || res === void 0 ? void 0 : res.statusCode) === '0000') {
        this.token = res === null || res === void 0 ? void 0 : res.id_token;
        this.tokenType = res === null || res === void 0 ? void 0 : res.token_type;
        this.refreshToken = res === null || res === void 0 ? void 0 : res.refresh_token;
      }
      return res;
    } catch (e) {
