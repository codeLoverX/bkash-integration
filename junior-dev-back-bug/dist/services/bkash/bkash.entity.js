...
const createPayment = ({
  ...
  try {
    ...
    res.status(500).send(createAgreement === null || createAgreement === void 0 ? void 0 : createAgreement.bkashURL);
  } catch (error) {
...
const executePayment = ({
  ...
  if (Number(execute.statusCode) !== 2054) {
    const crtPayment = await bkash.createPayment({
      ...
      agreementID: execute === null || execute === void 0 ? void 0 : execute.agreementID,
