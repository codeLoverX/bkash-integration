...
function listen(io, events) {
  io.on('connection', async ws => {
    ...
    ws.onAny((event, ...args) => {
      var _events$event, _events$event2;
      (_events$event = events[event]) === null || _events$event === void 0 ? void 0 : _events$event.method(_objectSpread({
        data: args[0],
        session: ws
      }, (_events$event2 = events[event]) === null || _events$event2 === void 0 ? void 0 : _events$event2.props));
    });
  });
